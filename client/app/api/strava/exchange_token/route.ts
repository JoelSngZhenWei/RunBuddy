...
export async function GET(req: NextRequest) {
  ...
  if (!clientId || !clientSecret) {
    console.error("[Strava] STRAVA_CLIENT_ID or STRAVA_CLIENT_SECRET is not set")
    return NextResponse.json(
      { 
        error: "Strava OAuth is not configured. Please set STRAVA_CLIENT_ID and STRAVA_CLIENT_SECRET in your environment variables.",
